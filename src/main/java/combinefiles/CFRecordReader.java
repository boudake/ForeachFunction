...
public class CFRecordReader extends RecordReader<FileLineWritable1, Text>{
  private long startOffset;
  private long end;
  private long pos;
  private FileSystem fs;
  private Path path;
  private FileLineWritable1 key;
  private Text value;
...
@Override
public FileLineWritable1 getCurrentKey() throws IOException, InterruptedException {
  return key;
}
